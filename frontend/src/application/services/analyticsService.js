...
class AnalyticsService {
  ...
  async getOrgLearningVelocity(organizationId) {
    try {
      const response = await api.get(`/org-admin/analytics/learning-velocity/${organizationId}`)
      return { ...response, source: 'backend' }
    } catch (error) {
  ...
  async getStrategicAlignment(organizationId) {
    try {
      const response = await api.get(`/org-admin/analytics/strategic-alignment/${organizationId}`)
      return { ...response, source: 'backend' }
    } catch (error) {
  ...
  async getDepartmentAnalytics(organizationId, departmentFilter = null) {
    try {
      const url = departmentFilter
        ? `/org-admin/analytics/department-analytics/${organizationId}?department=${departmentFilter}`
        : `/org-admin/analytics/department-analytics/${organizationId}`
      const response = await api.get(url)
      return { ...response, source: 'backend' }
    } catch (error) {
  ...
  async getLearningCulture(organizationId) {
    try {
      const response = await api.get(`/org-admin/analytics/learning-culture/${organizationId}`)
      return { ...response, source: 'backend' }
    } catch (error) {
